...
export default function UserDropdown() {
  ...
  return (
    <div ref={ref} class="relative inline-block text-left">
      ...
      {showDropdown &&
        <div class="absolute right-0 w-56 mt-2 origin-top-right rounded-md shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5">
          <div class="py-1 " role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <Link href="/modifyAccount" class="block px-4 py-2 text-md text-gray-100 hover:text-white hover:bg-gray-600" role="menuitem">
